public class Weapon
{
    ...
    public Weapon(String weaponName, int weaponType, String weaponRarity, int maxWeaponDamage, int minWeaponDamage, int weaponDamageType, boolean isTwoHanded, int range, int timeToUse, int weaponValue)
    {
